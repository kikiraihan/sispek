  ...
  <div class="col-lg-8 grid-margin">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="forms-sample " action="{{ url('akun/'.$akun->no_ref) }}" method="post">
          <hr>
          <input type="hidden" name="_method" value="patch">
          {{-- <input type="hidden" name="no_ref_lama" value="{{$akun->no_ref}}"> --}}
          {{ csrf_field()}} 
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              placeholder="no_ref" value="{{$akun->no_ref}}">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              placeholder="nama" value="{{$akun->nama}}">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="form-control form-control-sm" name="gol" tabindex="2">
